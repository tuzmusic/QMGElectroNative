...
export const indexResponse = [
  {
    ...
    listing_props: {
      ...
      _geolocation_lat: ["37.3598896"],
      _geolocation_long: ["-122.019102"],
      _company_price_from: [""],
      _company_price_to: [""],
      ...mockInfo
    }
  },
  {
    ...
    listing_props: {
      ...
      _geolocation_lat: ["37.32246610000001"],
      _geolocation_long: ["-122.0444706"],
  ...
  },
  {
    ...
    listing_props: {
      ...
      _job_location: ["6969 Cool Street"],
      _geolocation_lat: ["37.4219999"],
      _geolocation_long: ["-122.0840575"],
      _company_price_from: ["$10"],
      _company_price_to: ["$50"],
      ...mockInfo
    }
  },
  {
    ...
    listing_props: {
      ...
      _job_location: ["6969 Cool Street"],
      _geolocation_lat: ["37.3043165"],
      _geolocation_long: ["-122.072954"],
      _company_price_from: ["$10"],
      _company_price_to: ["$50"],
      ...mockInfo
    }
